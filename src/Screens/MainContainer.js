...
function MainContainer() {
  ...
  return (
    <div className='UserHead row bg-white '>
        <div className='col-3 pe-0 overflow-hidden'>
            <div className='UserColumn py-4 px-3'>
                <h1 className='text-center mb-1'>Welcome</h1>
                <h3 className='text-center mb-4'>Arturo Cruz</h3>
                <div className='d-flex justify-content-center'>
                    <img src={img1} className='UserView  rounded-pill' alt="" />
                </div>
                ...
                <div className='lockScreen  px-2 py-4 bg-white '>
                    ...
                    <div className='d-flex mt-4 me-3 align-items-center justify-content-end'>
        ...
        <div className='col-9 px-0 position-relative'>
            <header className='Header d-flex justify-content-between px-3 py-3'>
            ...
            <div className='chatSection px-5'>
            ...
            <div className='MessageSendSection px-5  d-flex justify-content-between align-items-center w-100 px-2 py-3 position-absolute bottom-0'>
